      ...
      <div className="w-10 h-10 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600">
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 012-2h5.586a1 1 0 01.707.293l1.414 1.414a1 1 0 01.293.707H19a2 2 0 012 2v1a2 2 0 01-2 2H5a2 2 0 01-2-2V17z"
          />
        </svg>
      </div>
    ),
...
const ScheduleItemCard = ({ schedule }: { schedule: Schedule }) => {
  const config =
    TYPE_CONFIG[schedule.schedule_type as ScheduleType] ||
    TYPE_CONFIG[ScheduleType.PENGUMPULAN];
    ...
    <div className="group bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-emerald-200 transition-all duration-200 relative overflow-hidden">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col items-center justify-center w-14 h-14 bg-gray-50 rounded-xl border border-gray-100 shrink-0 group-hover:bg-emerald-50 group-hover:text-emerald-700 transition-colors">
          <span className="text-xs font-bold text-gray-400 group-hover:text-emerald-600 uppercase">
            {month}
          </span>
          <span className="text-xl font-extrabold text-gray-800 group-hover:text-emerald-800">
            {day}
          </span>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex items-center gap-2">
            <div
              className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-xs font-medium border ${config.color.replace(
                "bg-",
                "bg-opacity-10 "
              )}`}
            >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Pantau jadwal pengumpulan sampah & pencairan di RW Anda.
              </p>
            </div>
          </div>
            ...
            {[
              ...
              return (
                <button
                  key={tab.value}
                  onClick={() =>
                    setTypeFilter(tab.value as ScheduleType | "ALL")
                  }
          ...
          <div className="space-y-4">
            {!user?.id ? (
              ...
              <div className="bg-orange-50 rounded-2xl p-8 text-center border border-orange-100">
                ...
                <p className="text-orange-600 text-sm mt-1 mb-4">
                  Silakan lengkapi data di profil Anda untuk melihat jadwal.
                </p>
              </div>
            ) : isLoading ? (
              // Loading State
          ...
          <div className="bg-blue-50/50 rounded-2xl p-5 border border-blue-100 flex gap-4">
            ...
            <div>
              ...
              <ul className="flex flex-col mt-2 space-y-1 text-sm text-blue-800">
                <p>
                  <span className="font-semibold">Pengumpulan:</span> Petugas
                  akan berkeliling mengambil sampah warga.
                </p>
                <p>
                  <span className="font-semibold">Pencairan:</span> Warga dapat
                  menukarkan saldo tabungan menjadi uang tunai di posko RW.
                </p>
                <p>
                  <span className="font-semibold">Jadwal: </span>Pastikan Anda
